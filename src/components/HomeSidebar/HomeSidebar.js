    ...
    <div className={`col col-lg-3 col-12 ${props.blLeft}`}>
      <div className="blog-sidebar">
        <div className="widget about-widget">
          ...
          <div className="social">
            <ul className="clearfix">
              <li>
                <Link onClick={ClickHandler} to="/blog-single/Visiting-Bethany">
        ...
        <div className="wpo-newsletter-widget widget">
          ...
          <span>
            By signing up you agree to our <a href="#">Privecy Policy</a>
          </span>
        </div>
        <div className="widget category-widget">
          ...
          <ul>
            ...
            <li>
              <Link onClick={ClickHandler} to="/blog">
                Inspiration <span>(07)</span>
              </Link>
            </li>
            <li>
              <Link onClick={ClickHandler} to="/blog">
                Fashion <span>(03)</span>
              </Link>
            </li>
            <li>
              <Link onClick={ClickHandler} to="/blog">
                Photography <span>(06)</span>
              </Link>
            </li>
            <li>
              <Link onClick={ClickHandler} to="/blog">
